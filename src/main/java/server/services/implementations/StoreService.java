...
public class StoreService implements IStoreService {
	...
	public Store changeStoreState(String code, boolean active) {
		...
		log.info("[StoreService][changeStoreState]: Store with code {} is now {}", code,
	...
	public void assignProductToStore(String storeCode, String productCode) {
		...
		if (stockRepository.findByProduct_CodeAndStore_Code(productCode, storeCode) != null) {
		...
		log.info("Successfully assigned product {} to store {} with stock code {}", productCode, storeCode,
				newStock.getCode());
	}
